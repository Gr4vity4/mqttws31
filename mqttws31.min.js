...
var Paho.MQTT = (function (u) {
  ...
  function F(a, b, c) {
    for (var h = 0; h < a.length; h++) {
      ...
      127 >= e
        ...
        : (2047 >= e
            ? (b[c++] = ((e >> 6) & 31) | 192)
            : (65535 >= e ? (b[c++] = ((e >> 12) & 15) | 224) : ((b[c++] = ((e >> 18) & 7) | 240), (b[c++] = ((e >> 12) & 63) | 128)), (b[c++] = ((e >> 6) & 63) | 128)),
          (b[c++] = (e & 63) | 128));
    }
    return b;
  }
  ...
  n.prototype.encode = function () {
    ...
    switch (this.type) {
      ...
      case 10:
        a |= 2;
        for (d = 0; d < this.topics.length; d++) (c[d] = m(this.topics[d])), (b += c[d] + 2);
        break;
      case 6:
        a |= 2;
        break;
    ...
    switch (this.type) {
      case 1:
        ...
        void 0 != this.willMessage &&
          ((f = r(this.willMessage.destinationName, m(this.willMessage.destinationName), l, f)), (f = y(e.byteLength, l, f)), l.set(e, f), (f += e.byteLength));
      ...
      case 8:
        ...
        break;
      case 10:
        for (d = 0; d < this.topics.length; d++) f = r(this.topics[d], c[d], l, f);
    }
    return b;
  };
  var H = function (a, b, c) {
        ...
        d = function () {
          this.isReset
            ? ((this.isReset = !1),
              ...
              (this.timeout = this._window.setTimeout(e(this), this._keepAliveInterval)))
            : (this._client._trace("Pinger.doPing", "Timed out"), this._client._disconnected(g.PING_TIMEOUT.code, f(g.PING_TIMEOUT)));
        };
      this.reset = function () {
        this.isReset = !0;
    ...
    k = function (a, b, c, h, e) {
      ...
      this._sequence = 0;
      for (var d in localStorage) (0 != d.indexOf("Sent:" + this._localKey) && 0 != d.indexOf("Received:" + this._localKey)) || this.restore(d);
    };
  k.prototype.host;
  k.prototype.port;
  k.prototype.path;
  ...
  k.prototype.subscribe = function (a, b) {
    ...
    b.timeout &&
      (c.timeOut = new D(this, window, b.timeout, b.onFailure, [
        { invocationContext: b.invocationContext, errorCode: g.SUBSCRIBE_TIMEOUT.code, errorMessage: f(g.SUBSCRIBE_TIMEOUT) },
      ]));
  ...
  k.prototype.unsubscribe = function (a, b) {
    ...
    b.timeout &&
      (c.timeOut = new D(this, window, b.timeout, b.onFailure, [
        { invocationContext: b.invocationContext, errorCode: g.UNSUBSCRIBE_TIMEOUT.code, errorMessage: f(g.UNSUBSCRIBE_TIMEOUT) },
      ]));
    this._requires_ack(c);
    this._schedule_message(c);
  };
  ...
  k.prototype.restore = function (a) {
    ...
    0 == a.indexOf("Sent:" + this._localKey)
      ? ((h.payloadMessage.duplicate = !0), (this._sentMessages[h.messageIdentifier] = h))
      : 0 == a.indexOf("Received:" + this._localKey) && (this._receivedMessages[h.messageIdentifier] = h);
  };
  ...
  k.prototype._handleMessage = function (a) {
    ...
    try {
      switch (a.type) {
        ...
        case 5:
          if ((c = this._sentMessages[a.messageIdentifier]))
            (c.pubRecReceived = !0), (k = new n(6, { messageIdentifier: a.messageIdentifier })), this.store("Sent:", c), this._schedule_message(k);
          break;
        case 6:
  ...
  k.prototype._disconnected = function (a, b) {
    ...
    this.socket &&
      ...
      delete this.socket);
    if (this.connectOptions.uris && this.hostIndex < this.connectOptions.uris.length - 1) this.hostIndex++, this._doConnect(this.connectOptions.uris[this.hostIndex]);
